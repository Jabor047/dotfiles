...
if [ -f '/Users/kev_in/Downloads/google-cloud-sdk/path.zsh.inc' ]; then . '/Users/kev_in/Downloads/google-cloud-sdk/path.zsh.inc'; fi
...
complete -o nospace -C /Users/kev_in/bin/terraform terraform
